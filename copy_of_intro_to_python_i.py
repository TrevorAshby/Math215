...
Original file is located at
    https://colab.research.google.com/drive/163QvkjjysuC2VaoI1IO84dFo5r0ipCur
...
def combine(x,y):
  y=triple(y) 
  z=avg(x,y) # Put your code here.  Remember that this function should call both of the functions triple(y) and avg(x,y) from above.
...
def swap(c):
  ...
  w=original_list.copy()
  w[0] = original_list[-1]
  w[-1] = original_list[0] # Put your code here.
  return w # Put your return value here.
