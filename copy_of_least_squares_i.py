...
Original file is located at
    https://colab.research.google.com/drive/190O9hNyr3UlyvCaCblX4nWGBwgHTafDz
...
def ls1_line(x): 
  v0, a = beta1 # Put your code here.
  return v0 + a * x# Put your return value here.
...
X2T = np.transpose(X2)
normal_coef2= np.matmul(X2T, X2)

normal_vect2= np.matmul(X2T, Y2)
...
def ls2_par(x): 
  v0, a = beta2 # Put your code here.
  return v0 * x + a * x * x # Put your return value here.
...
def create_plots2():
  x= np.linspace(0,75,10) # Put all of your code to create the plots here.
  y= ls2_par(x)
  plt.plot(x, y)
  plt.show()
  return None
