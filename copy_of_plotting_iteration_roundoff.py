...
Original file is located at
    https://colab.research.google.com/drive/13T_YJkZnmONd_A8NFL8y28Fb5LK3q_FQ
...
def create_plots():
  ...
  plt.plot(x,y)
  plt.plot(x,z)
  plt.show() # Put all of your code to create the plot here.
  return None
...
def create_scatter_plot():
  ...
  plt.show() # Put all of your code to create the scatter plot here.
  return None
...
def fact(n):
  if n==0:
    ...
    sum = n*fact((n-1))
    return sum # Place the remaining part of your code here.
